...
public class RetractAmpAssistCommand extends Command {
  private AmpAssistSubsystem m_AmpAssistSubsystem; 
  /** Creates a new RetractAmpAssistCommand. */
  public RetractAmpAssistCommand(AmpAssistSubsystem ampAssistSubsystem) {
  ...
  return false;//m_AmpAssistSubsystem.AtPosition(false);
  }
}
